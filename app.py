...
def response_message(event):
    ...
    if checktext in ['肉', 'お肉', 'にく', 'ニク', 'おにく']:
        ...
        messages = TextSendMessage(text='やあ （´・ω・｀)ようこそ、バーボンハウスへ。¥nこのテキーラはサービスだから、まず飲んで落ち着いて欲しい。¥n¥nうん、「また」なんだ。済まない。¥n仏の顔もって言うしね、謝って許してもらおうとも思っていない。¥nでも、このスレタイを見たとき、君は、きっと言葉では言い表せない「ときめき」みたいなものを感じてくれたと思う。¥n殺伐とした世の中で、そういう気持ちを忘れないで欲しいそう思って、このスレを立てたんだ。¥nじゃあ、注文を聞こうか。')        
